...
set ipfs_ext "vo"
if {[file exists test1.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find test1.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME test1_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.test1_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "test1.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "test1_tb.${hdl_ext}" -section_id tb -library work
