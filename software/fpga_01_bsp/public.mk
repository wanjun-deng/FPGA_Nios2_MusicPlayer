...
SOPCINFO_FILE := D:/Github_Repository/FPGA_01/mysystem.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1858
SOPC_SYSID_FLAG += --sidp=0x1858
ELF_PATCH_FLAG  += --sidp 0x1858

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1766937614
SOPC_SYSID_FLAG += --timestamp=1766937614
ELF_PATCH_FLAG  += --timestamp 1766937614
